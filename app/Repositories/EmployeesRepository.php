...
class EmployeesRepository extends AcademicYRepository
{
    ...
    {
        return DB::table('users')->where('users.id', $academic->user_id)->join('academics', 'users.id', '=', 'academics.user_id')->join('group_subjects', 'academics.user_id', '=', 'group_subjects.teacher_id')->join('subjects_levels', 'group_subjects.subject_id', '=', 'subjects_levels.id')->join('subjects', 'subjects_levels.subject_id', '=', 'subjects.id')->join('levels', 'subjects_levels.level_id', '=', 'levels.id')->join('departments', 'levels.department_id', '=', 'departments.id')->join('groups', 'group_subjects.group_id', '=', 'groups.id')->where('group_subjects.ay_id', $this->currentAcademicYear->id)->where('subjects_levels.semester', $this->currentAcademicYear->term)->select(
                'subjects.name_ar as subject',
                'levels.name as level',
                'departments.name as department',
                'groups.name as group',
                'subjects_levels.semester as semester',
                'subjects_levels.id as subject_level_id',
                'group_subjects.id as group_subject_id',
                'group_subjects.group_id as group_id',
                'group_subjects.subject_id as subject_id',
                'group_subjects.teacher_id as teacher_id'
            );
    }
    ...
    {
        return DB::table('users')->where('id', $academic->user_id)->join('academics', 'users.id', '=', 'academics.user_id')->join('group_subjects', 'academics.user_id', '=', 'group_subjects.Teather_id')->join('groups', 'group_subjects.group_id', '=', 'groups.id')->join('levels', 'groups.level_id', '=', 'levels.id')->join('departments', 'levels.department_id', '=', 'departments.id')->where('group_subjects.ay_id', $this->currentAcademicYear->id)->select('groups.name as group', 'levels.name as level', 'departments.name as department');
    }
    ...
    public function getSubjectsable()
    {
        return DB::table('subjects')->
            ...
            join('subjects_levels', 'subjects.id', '=', 'subjects_levels.subject_id')->join('levels', 'subjects_levels.level_id', '=', 'levels.id')->join('departments', 'levels.department_id', '=', 'departments.id');
    }
