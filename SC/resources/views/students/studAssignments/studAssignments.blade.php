...
<div class="hdr2" style=" box-shadow: 10px;">
    ...
    <div id="btn-group-assignementsStudents">
        ...
        <a href="{{route("student-DoneAssignements")}}"> <button id="btn-assignementsStudentsksNavbar" class="btn btn-light"><label class="">   مرسلة</label></button></a>
        <button id="btn-assignementsStudentsksNavbar" class="btn btn-light"><label class="">  غير مرسلة </label></button>
        <a href="{{route("student-assignements")}}"><button id="btn-assignementsStudentsksNavbar" class="btn btn-light" style="background-color: #a9cbf7;text-decoration: none;border-bottom: 4px solid #2f81ec;"><label class="">  القائمة </label></button></a>
    </div>
