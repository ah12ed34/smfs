...
<div class="dropdown">
    ...
    <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">
        @if ($active['tab'] != 'departmentLevels')
            <a id="" class="dropdown-item" href='{{ route('managerDepartment') }}'style="padding-left:30px; ">
                المستويات</a>
        @endif
...
{{-- <div class="dropdown">
    <button type="button"  class="btn btn-light departmentNavbar_dropdown  dropdown-toggle" data-toggle="dropdown" dir="rtl">
        ...
        <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">
            ...
            <a id="" class="dropdown-item" href='{{route('managerDepartAcademics')}}'style="padding-left:30px; ">  الأكاديميين</a>
...
<div class="btn-group btn_group_nav_manageDepart" id="">
    ...
    <button
        @if ($active['tab'] == 'departmentStatistics') style="background-color: #a9cbf7;text-decoration: none;border-bottom: 4px solid #2f81ec;" @endif
    ...
    {{-- @if ($active['tab'] == 'departmentNotifications')     --}}
    <button
        @if ($active['tab'] == 'departmentNotifications') style="background-color: #a9cbf7;text-decoration: none;border-bottom: 4px solid #2f81ec;" @endif
    ...
    <button
        @if ($active['tab'] == 'departmentAcademic') style="background-color: #a9cbf7;text-decoration: none;border-bottom: 4px solid #2f81ec;" @endif
        class="btn-manageDepart-Navbar    " onclick="location.href='{{ route('managerDepartAcademics') }}'">
        <label class="proNavbartext"> الأكاديميين</label></button>
    {{-- @if ($active['tab'] == 'levels') --}}

    <button
        @if ($active['tab'] == 'departmentLevels') style="background-color: #a9cbf7;text-decoration: none;border-bottom: 4px solid #2f81ec;" @endif
