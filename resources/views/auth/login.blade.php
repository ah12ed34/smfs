        ...
        <div class="overlay"  >
            ...
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container">
                    ...
                    <div class="img-fluid logo_system"><img src="{{ Vite::image('Group 912.png') }}" width="40%"> </div>
                </div>
            </nav>
            <div class="content login" style="background: no-repeat;">
                <form class="login-form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control input_userInfo" placeholder="الإيميل...." @if($errors->has('email') || $errors->has('username')) is-invalid @endif" name="username" value="{{ old('email') ?: old('username') }}" required autocomplete="username" autofocus >
