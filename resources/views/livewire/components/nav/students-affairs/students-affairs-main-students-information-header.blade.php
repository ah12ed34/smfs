    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        <div id="" class="input-group input_search_studentsAffairs_studentInfo">
            ...
            <div class="input-group-append">
                <button id="form-control" class="btn btn-light" wire:click='srch'><img
                        src="{{ Vite::image('magnifying-glass (2).png') }}" id="spaces2" width="20px"></button>
            </div>
        </div>

        <button type="submit" class="btn btn-primary btn-sm btn_uploade_file_information_students " id=""
            data-toggle="modal" data-target="#myModal"> رفع ملف<img src="{{ Vite::image('plus.png') }}" width="20px"
                style="float: left; margin-left:0px;"></button>

        <button type="submit" class="btn btn-primary btn-sm  btn_studentsAffairs_AddStudent" id=""
            data-toggle="modal" data-target="#AddaStudentModal"> اضافة طالب<img src="{{ Vite::image('plus.png') }}"
                width="20px" style="float: left;"></button>
