<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        <button class=" spaces"> <label class="subjectname" style="margin-left: -10px;"> مسؤول الجداول </label><img
        ...
        <button type="submit" class="btn btn-primary btn-sm  btn_Add_Sechedule" id="" data-toggle="modal"
            data-target="#create-subject"> اضافة مادة<img src="{{ Vite::image('plus.png') }}" width="20px"
    ...
    <div class="hr3">
        <button id="spacesbtn" class="spaces" onclick="window.location='{{ route('quality_board_main', $level->id) }}'">
