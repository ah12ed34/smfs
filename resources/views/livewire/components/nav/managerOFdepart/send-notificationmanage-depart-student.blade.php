<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        <div class="dropdown">
            ...
            <div id="dropdown-menulist" class="dropdown-menu">
                <a id="dropdown-students-itemlist" class="dropdown-item" href="#" style="padding-left:40px;">
                    مستوى اول</a>
                <a id="dropdown-students-itemlist" class="dropdown-item" href="#" style="padding-left:30px;">مستوى
                    ثاني</a>
        ...
        <button id="" type="button"
            class="btn btn-light manageDepart-groups-sentnotifications dropdown-toggle" data-toggle="dropdown"
            dir="rtl">
            جميع المجموعات
        </button>
        <div id="dropdown-menulist" class="dropdown-menu">
        ...
        <div class="dropdown">
            ...
            <button id="" type="button"
                class="btn btn-light manageDepart-spacific-studentsdropdown dropdown-toggle" data-toggle="dropdown"
                aria-placeholder=" تحديد طلاب" dir="rtl">
                تحديد طلاب
            </button>
    ...
    <div class="hr3">
        <button id="spacesbtn" class="spaces" onclick="location.href='{{ route('notifications_manageDrpart') }}'">
