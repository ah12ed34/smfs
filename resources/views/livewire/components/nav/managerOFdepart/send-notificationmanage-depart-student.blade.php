<div>
    ...
    <div class="hr3">
        <button id="spacesbtn" class="spaces" onclick="location.href='{{route('notifications_manageDrpart')}}'"> <img src="{{Vite::image("left-arrow.png")}}" id="spaces1"  width="30px"></button>
