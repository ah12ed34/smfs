<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        <div class="dropdown">
            <button type="button"
                class="btn btn-light departmentNavbar_dropdown academicNavbar_dropdown  dropdown-toggle"
                data-toggle="dropdown" dir="rtl">
                <div class="textdropdown"> الأكاديميين </div>
            </button>
        ...
        <div class="btn-group btn_group_nav_manageDepart" id="">
            ...
            <button class="btn-manageDepart-Navbar" onclick="location.href='{{ route('managerDepartAcademics') }}'"
                style="background-color: #a9cbf7;text-decoration: none;
        ...
        <td><button type="submit" class="btn btn-primary btn-sm  manageDepart-addAcademic" id=""
                data-toggle="modal" data-target="#addacademic"> اضافة اكاديمي <img src="{{ Vite::image('plus.png') }}"
                    width="20px" style="float: left;"></button> </td>
