<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        {{-- <div  class="btn-group btn_group_nav_manageDepart-level" id="">
                ...
                <button class="btn-manageDepart-level-Navbar" onclick="location.href='{{route('depart_level_mainPage')}}'"><label class="proNavbartext"> الأكاديميين</label></button>
    ...
    <div class="hr3">
        <button id="spacesbtn" class="spaces"
            onclick="location.href='{{ route('depart_level_Group_mainPage', [$level->id]) }}'"> <img
