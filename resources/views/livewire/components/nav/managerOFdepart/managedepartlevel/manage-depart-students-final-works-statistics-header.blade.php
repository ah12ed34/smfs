<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        <div class="btn-group btn_group_nav_manageDepart-level" id="">
            <button class="btn-manageDepart-level-Navbar"
                onclick="location.href='{{ route('depart_level_studentsFinalTearmStatistics') }}'"><label
                    class="proNavbartext">الإحصائيات </label></button>
            <button class="btn-manageDepart-level-Navbar"
                onclick="location.href='{{ route('depart_level_allsechedules') }}'"><label class="proNavbartext"> الجدول
                    الدراسي</label></button>
            <button class="btn-manageDepart-level-Navbar"
                onclick="location.href='{{ route('depart_level_Books') }}'"><label class="proNavbartext"> المقرر الدراسي
                </label></button>
            <button class="btn-manageDepart-level-Navbar"
                onclick="location.href='{{ route('depart_level_academic') }}'"><label class="proNavbartext">
                    الأكاديميين</label></button>
            <button class="btn-manageDepart-level-Navbar"
                onclick="location.href='{{ route('depart_level_Group_mainPage') }}'"><label class="proNavbartext">
        ...
        <div class="dropdown">
            <button type="button" class="btn btn-light manageDepartlevelNavbar_dropdown  dropdown-toggle"
                data-toggle="dropdown" dir="rtl">
                <div class="textdropdown"> الإحصائيات</div>
            </button>
            <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">
                <a id="" class="dropdown-item" href='{{ route('depart_level_Group_mainPage') }}'
                    style="padding-left:30px; ">المجموعات </a>
                <a id="" class="dropdown-item" href='{{ route('depart_level_academic') }}'
                    style="padding-left:30px; "> الأكاديميين</a>
                <a id="" class="dropdown-item" href='{{ route('depart_level_Books') }}'
                    style="padding-left:30px; "> المقرر الدراسي</a>
                <a id="" class="dropdown-item"
                    href='{{ route('depart_level_allsechedules') }}'style="padding-left:30px; "> الجدول الدراسي</a>
        ...
        <div class="dropdown">
            <button type="button"
                ...
                data-toggle="dropdown" dir="rtl">
                <div class="textdropdown"> نظم موزعة </div>
            </button>
            <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">

                <a id="" class="dropdown-item" href="#" style="padding-left:30px; "> جميع المقرر </a>
                <a id="" class="dropdown-item" href="#" style="padding-left:30px; "> التحقيق الرقمي
                </a>
                <a id="" class="dropdown-item" href="#" style="padding-left:30px; "> التجارة
                    الالكترونية </a>
        ...
        <div class="dropdown">
            <button type="button"
                class="btn btn-light MnageDepart_studentsFinalWorks_Statistics_TypeSubjec_dropdown  dropdown-toggle"
                data-toggle="dropdown" dir="rtl">
                <div class="textdropdown"> نظري</div>
            </button>
            <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">
                <a id="" class="dropdown-item" href="#" style="padding-left:30px; "> عملي</a>
                <a id="" class="dropdown-item" href="#" style="padding-left:30px; "> نظري\عملي </a>
            </div>
        </div>
        {{--
    ...
    <div class="hr3">
        <button id="spacesbtn" class="spaces" onclick="location.href='{{ route('depart_level_Group_mainPage') }}'">
