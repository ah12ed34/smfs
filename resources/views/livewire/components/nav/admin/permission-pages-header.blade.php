<div>
    ...
    <td><button type="submit" class="btn btn-primary btn-sm  btn-addAcademic" id="" data-toggle="modal" data-target="#addUserPermissions"> اضافة صلاحية<img src="{{ Vite::image('pluspng')}}"  width="20px" style="float: left;"></button> </td>
