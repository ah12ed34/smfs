<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        <button class=" spaces"> <label class="subjectname"> الأدمن </label><img src="{{ Vite::image('admin.png') }}"
        ...
        <div id="" class="input-group input_search_studentsAffairs_studentInfo">
            ...
            <div class="input-group-append">
                <button id="form-control" class="btn btn-light" type="submit"><img
                        src="{{ Vite::image('magnifying-glass (2).png') }}" id="spaces2" width="20px"
                        wire:click='srch'></button>
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-primary btn-sm  btn_addEmployee_user" id="" data-toggle="modal"
            data-target="#AddEmployeerModal" wire:click="addUser()"> اضافة <img src="{{ Vite::image('plus.png') }}"
    ...
    <div class="hr3">
        <button id="spacesbtn" onclick="window.location='{{ route('admin.employees') }}'" class="spaces"> <img
