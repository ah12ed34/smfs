    ...
    <div class="dropdown">
        <button type="button"  class="btn btn-light departmentNavbar_dropdown  dropdown-toggle" data-toggle="dropdown" dir="rtl">
            ...
            <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">
                ...
                <a id="" class="dropdown-item" style="padding-left:30px; " href="{{ route('admin.academic_departments') }}"> الأكادميين</a>
                @endif
...
--}}
    ...
    @if ($active=='academic')
        <div class="hr3">
            <button id="spacesbtn" class="spaces back_academic_mobile" onclick="window.location='{{ route('admin.academic_departments', $department->id) }}'" > <img src="{{Vite::image("left-arrow.png")}}" id="spaces1"  width="30px"></button>
