...
<div>
    ...
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        <div class="dropdown">
            ...
            <div id="dropdown-itemlist" class="dropdown-menu" style=" color: #0E70F2; ">
                ...
                <a id="" class="dropdown-item"
                    href='{{ route('notifications_manageDrpart') }}'style="padding-left:30px; "> الإشعارات</a>
        ...
        <div class="btn-group btn_group_nav_manageDepart" id="" style="left: 0%">
            ...
            <button class="btn-manageDepart-Navbar" onclick="location.href='{{ route('notifications_manageDrpart') }}'"
                style="background-color: #a9cbf7;
            text-decoration: none;
            border-bottom: 4px solid #2f81ec;"><label
                    class="proNavbartext"> الإشعارات</label></button>
    ...
    <div class="container" style="padding-top: 10px;">
        ...
        <div class="card  cards-departments" id="" data-toggle="modal"
        ...
        <div class="card  cards-departments" id="" data-toggle="modal"
            data-target="#ModalSendNotifictionsAcademic">
    ...
    <div class="modal fade" id="ModalSendNotifictionsStudents">
        <div class="modal-dialog">
            ...
            <a id="dropdown-students-itemlist" class="dropdown-item" href="#" style="padding-left:30px;">   </a> --}}
                        ...
                        <div class="dropdown">
                            <button id="" type="button"
                                class="btn btn-light specific_group dropdown-toggle" data-toggle="dropdown"
                                dir="rtl" style="float: left; left:40px;">
                                جميع المجموعات
                            </button>
                            <div id="dropdown-menulist" class="dropdown-menu">
                                <a id="dropdown-students-itemlist" class="dropdown-item" href="#"
                ...
                <img src="{{Vite::image("send.png")}}" id="send-png" width="25px"> --}}
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control send-input" id="messageInput"
                            placeholder="اكتب..." style="height: 35px;margin-top: -10px;">
                        <div class="input-group-append">
                            <button class="btn btn-light" type="button" id="sendButton"
                                style="margin-top: -10px;height: 35px;margin-left:5px"><img
                                    src="{{ Vite::image('send.png') }}" width="24px"></button>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="ModalSendNotifictionsAcademic">
        <div class="modal-dialog">
            ...
            <a id="dropdown-students-itemlist" class="dropdown-item" href="#" style="padding-left:30px;">   </a> --}}
                        ...
                        {{-- <button id="" type="button" class="btn btn-primary specific_students" data-toggle="modal" data-target="#MoadalspacificStudents" > تحديد الأكاديميين </button> --}}
