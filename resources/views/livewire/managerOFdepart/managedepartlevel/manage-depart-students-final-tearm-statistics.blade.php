@section('nav')
    @livewire('components.nav.manager_of_depart.managedepartlevel.manage-depart-students-final-tearm-statistics-header', ['level' => $level, 'groups' => $groups, 'subjects' => $subjects, 'active' => $active, 'terms' => $terms])
@endsection
@section('homeLayout')
