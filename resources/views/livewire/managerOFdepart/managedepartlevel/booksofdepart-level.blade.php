    ...
    {{-- Success is as dangerous as failure. --}}
        ...
        <div class="container"  style="padding-top:30px;">
            ...
            <div class="card" style="overflow: hidden;"
                id="cards-subject-students" onclick="location.href='{{route('depart_level_booksChapters',[$level->id,$subject->subjects_levels->first()->id])}}'">
                <img src="{{$subject->image ? asset('storage/'.$subject->image):Vite::image("allocation (1).png")}}" class="" width="150px">
                <div class="card-subject-child" style="overflow:auto;scrollbar-width:none;
