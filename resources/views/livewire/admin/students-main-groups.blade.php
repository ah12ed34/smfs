@section('nav')
@livewire('components.nav.admin.students-main-groups-header'
                ...
                <table class="table" style=" width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr class="table-light" id="modldetials" style="margin-top:7px;">
                            ...
                            <td><button type="submit" class="btn btn-primary btn-sm" id="btn-detials" data-toggle="modal" data-target="#myModal2" onclick="location.href='{{route('show_student_inGroups',[$level->id,$group->id])}}'">عرض</button> </td>
