...
@section('nav')
    <div class="hdr2" style=" box-shadow: 10px;">
        ...
        <div class="btn-group btn_group_nav_manageDepart-level" id="">
            ...
            <button class="btn-manageDepart-level-Navbar"><label class="proNavbartext"> الأكاديميين</label></button>
    ...
    <div class="hr3">
        ...
        <button id="spacesbtn" class="spaces"
            onclick="window.location='{{ route('department.levels', $id->department->id) }}'"> <img
            ...
            <table class="table" style=" width:100%;">
                ...
                <tbody>
                    @forelse ($groups as $group)
                        <tr class="table-light"@if ($loop->first) id="modldetials" style="margin-top:7px;cursor: pointer;" @else style="cursor: pointer" @endif
                            onclick="window.location='{{ route('group.add-student', $group->id) }}'">
                            <td>***********</td>
                            <td>***********</td>
