...
@section('nav')
    ...
    <div class="hr3">
        <button id="spacesbtn" onclick="window.location='{{ route('control_grades_main', $level->id) }}'" class="spaces"> <img
...
@section('content')
    <div class="container" style="padding-top: 30px;">
        ...
        <div class="cards-child-stastics"
            onclick="location.href='{{ route('control_final_reasults_students', $level->id) }}'">
