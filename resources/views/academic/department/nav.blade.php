...
<div class="dropdown">
    ...
    <div  class="btn-group btn_group_nav_manageDepart" id="">
        ...
        <button class="btn-manageDepart-Navbar" onclick="window.location='{{ route('department.academics',$department->id) }}'"><label class="proNavbartext"> الأكادمين</label></button>
        <button class="btn-manageDepart-Navbar"><label class="proNavbartext" onclick="window.location='{{ route('department.levels',$department->id
