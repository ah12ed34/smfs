...
<div class="container" style="padding-top:60px;">
    ...
    <div id="card-studyingbooksforms-quiz" class="card">
        ...
        <div id="card-studyingbooks-child">
            <img src="{{Vite::image("M.L.H DS Mid exams_page-0001.jpg")}}" class="chapters" width="220px">
    ...
    <div id="card-studyingbooksforms-quiz" class="card">
        <div id="card-studyingbooks-child">
            <img src="{{Vite::image("M.L.H DS Mid exams_page-0002.jpg")}}" class="chapters" width="220px">
    ...
    <div id="card-studyingbooksforms-quiz" class="card">
        <div id="card-studyingbooks-child">
            <img src="{{Vite::image("M.L.H DS Mid exams_page-0003.jpg")}}" class="chapters" width="220px">
            <!-- <div id="card-studyingbooks-child-2"> -->
    ...
    <div id="card-studyingbooksforms-quiz" class="card">
        <div id="card-studyingbooks-child">
            <img src="{{Vite::image("M.L.H DS Mid exams_page-0004.jpg")}}" class="chapters" width="220px">
