        ...
        <div id="card-HW" class="card bg-light text-dark" style=" color: #0E70F2;">
            <div class="card-body">
                <div class="btn-HW">
                    ...
                    <button type="submit" class="btn btn-light" id="btn-recive-hw" data-toggle="modal" data-target="#myModalediteAssign" style="background-color: #ffffff;box-shadow: 0px 0px 2px 0px rgb(67, 111, 206);color: #0E70F2;border: none; width: 90px;height: 33px;">تعديل  <img src="{{Vite::image("edit.png")}}" id=""  width="15px" ></button>
