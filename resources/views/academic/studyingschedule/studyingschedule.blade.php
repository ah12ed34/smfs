...
@section('nav')
    ...
    <div class="hr3">
        <button id="spacesbtn" onclick="window.location='{{ route('main_academic_sechedules') }}'" class="spaces"> <img
...
@section('content')
    <div class="container" style=" padding-top: 10px;">
        ...
        <div class="card w-100 h-100 right-6 left-0 top-2  " id="card-img-schedule">
            <div class="card  maxh-10 w-100 right-0 left-0 top-0  badge-primary text-bg-light text-center font-medium"
                id="card-title-schedule"> جدول الأكادميين</div>
            <img class="img-fluid" src="{{ $schedule ? asset('storage/' . $schedule) : null }}" alt='جدوال' width="600px"
                height="350px">
        </div>
