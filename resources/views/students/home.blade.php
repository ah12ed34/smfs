...
@section('content')
    <div style="padding-bottom:30px; padding-left:-5px;padding-left:-5px;">
        ...
        <div class="card" id="cards-child-subject" onclick="location.href='{{ route('student-stastistics') }}'"><img
                src="{{ Vite::image('bar-chart (4).png') }}" class="imgs-boards" width="100px"
        ...
        <div class="card" id="cards-child-subject" onclick="location.href='{{ route('student-studyingbooks') }}'"><img
        ...
        <div class="card" id="cards-child-subject" onclick="location.href='{{ route('student-assignements') }}'"><img
        ...
        <div class="card" id="cards-child-subject" onclick="location.href='{{ route('student-projects') }}'"><img
