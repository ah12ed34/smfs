...
<div class="hdr2" style=" box-shadow: 10px;">
    ...
    <div id="btn-group-proj" class="btn-group">
        ...
        <a href="{{route("student-projectsStastics")}}">  <button class="btn-projctsNavbarproj" style="background-color: #a9cbf7;text-decoration: none;border-bottom: 4px solid #2f81ec;"><label class="proNavbartext">الإحصائيات</label></button></a>
        ...
        <a href="{{route("student-projects")}}">  <button class="btn-projctsNavbarproj"><label class="proNavbartext">الكل</label></button></a>
    </div>
    ...
    <div id="dropdown-menulist" class="dropdown-menu" style="width:130px; color: #0E70F2; ">   
             <a id="dropdown-itemlist" class="dropdown-item" href="{{route("student-projects")}}">جميع المشاريع</a>
